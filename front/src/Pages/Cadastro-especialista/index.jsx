                ...
                <div className="cadastro-page">
                    ...
                    <h1 className="cadastro">Cadastro</h1>
                        ...
                        <form action="formulario2">
                            <button type="image" src="front\src\assets\comunicacao.svg" alt=""></button>
                            <button type="image" src="front\src\assets\comunicacao.svg" alt=""></button>
                            <button type="image" src="front\src\assets\comunicacao.svg" alt=""></button>
                            <input className="crp-cad" type="number" id="crp" placeholder="CRP" />
                            <input className="ano-cad" type="date" id="ano" placeholder="Em que ano você começou a realizar consulta" />
                        </form>    
                        </div>   
                </div>
            </Container>

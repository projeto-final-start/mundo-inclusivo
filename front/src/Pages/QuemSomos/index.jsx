  ...
  return (
      ...
      <div className="parte1">
        ...
        <p>
          ...
          Os profissionais estarão prontos para te atender e você pode ver as
          avaliações <br /> de outros pacientes. Também é possível avaliar o
        ...
        <p>
          ...
          Mundo Inclusivo não possui custo, pagamentos só serão realizados por
        ...
        <p>
          ...
          Inclusivo, basta escolher qual seu convênio quando for realizar uma
          busca e aparecerá uma lista de especialistas na sequência. Se você não
          encontrou seu convênio em nossa lista, não se preocupe. Envie uma
          solicitação para nosso e-mail: voluntariamentefigma@gmail.com
          informando o nome do seu convênio e plano de saúde para que possamos
        ...
        <p>
          ...
          nascimento e gênero para criar uma conta no Mundo Inclusivo e realizar
          um agendamento.
        </p>
        <br />
        ...
        <p>
          ...
          segurança HIIPA e está atualizado quanto a LGPD, além de diversas
          proteções internas que garantem a segurança de seus dados e sua
          consulta.
        </p>
        <br />
